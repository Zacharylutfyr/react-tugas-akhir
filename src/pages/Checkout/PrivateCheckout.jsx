...
import TravelarkGreen from '../../assets/img/travelark-green.png'
      ...
      <div class='checkout'>
        <div class='container'>
          <div class='checkout1 d-flex justify-content-center'>
            <img src={TravelarkGreen} alt='travelark-green.png' />
            <img src={Line2} class='line' alt='line-2.png' />
          ...
          <div class='card card-checkout'>
            ...
            <div class='row p-3'>
              ...
              <div class='col-lg-3 mt-2'>
                <label for='datepicker' class='me-2'>
                  Tickets date
                </label>
            ...
            <div class='row p-3'>
              <div class='col-lg-3 mt-2'>
                <label for='firstname-checkout' class='firstname'>
                  First Name
                </label>
              ...
              <div class='col-lg-3 mt-2'>
                <label for='lastname-checkout' class='lastname'>
                  Last Name
                </label>
              ...
              <div class='col-lg-3 mt-2'>
                <label for='email-checkout' class='email'>
                  Email
                </label>
      ...
      <div class='container'>
        <div class='row'>
          ...
          <div class='col-lg-12 mt-3'>
            <p>
              Destination trip can be used as much as you order the ticket.
              Check again your summary order before continue your order. After
              you finish your payment, every tickets will be shown in your
              ticket page and sent into your email (include with destination
